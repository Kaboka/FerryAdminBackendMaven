DROP TABLE SCHEDULE_HAS_DEPARTURE;
DROP TABLE SCHEDULE;
DROP TABLE RESERVATION_HAS_TRAVELING_ENTITY;
DROP TABLE RESERVATION;
DROP TABLE DEPARTURE_HAS_CONFIGS;
...
create table DEPARTURE_HAS_CONFIGS (
	departure_id int references DEPARTURE(id),
	ferry_config_id int references FERRY_CONFIG(id),
	primary key(departure_id, ferry_config_id)
);
...
create table SCHEDULE_HAS_DEPARTURE(
    schedule_id int references SCHEDULE(id),
    departure_id int references DEPARTURE(id),
    primary key(schedule_id, departure_id)
);